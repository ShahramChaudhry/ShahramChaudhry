...
## 🚀 Featured Projects  
📌 **[Churn Prediction Web App](https://churnpredictor-73nfeb0hl-shahramchaudhrys-projects.vercel.app)** – ML-powered app predicting customer churn with **90% accuracy**.  
📌 **[JetSetGo](https://jet-set-go-xi.vercel.app)** – Full-stack travel itinerary planner with **visa verification & dynamic trip planning**.  
📌 **[LastCrumb]** – Mobile app (Flutter) **reducing food waste** through community-driven food redistribution.  
📌 **[Inventory Management System](https://inventory-tracker-peach.vercel.app)** – Real-time **React + Firebase** inventory tracker used by clinics.  
